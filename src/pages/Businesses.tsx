...
import { useFetchBusinessesQuery } from "../store/services/business";
import AddBusiness from "../components/businesses/modals/AddBusiness";
import UpdateBusiness from "../components/businesses/modals/UpdateBusiness";
...
const Businesses = () => {
  ...
  return (
    <>
      <AddBusiness open={openAdd} setOpen={setOpenAdd} />
      <UpdateBusiness id={selected} open={openUpdate} setOpen={setOpenUpdate} />
                    ...
                    .map((business, idx) => (
                      ...
                      >
                        ...
                        <td
                          ...
                          className="px-3"
                        >
                          <span className="text-xs">{business.code}</span>
                        </td>
                        <td
                          onClick={() => {
                            setSelected(business.id);
