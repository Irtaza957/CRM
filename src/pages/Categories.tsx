...
import AddCategory from "../components/categories/modals/add/AddCategory";
import UpdateCategory from "../components/categories/modals/update/UpdateCategory";
...
const Categories = () => {
  ...
  return (
    <>
      ...
      <UpdateCategory id={selected} open={openUpdate} setOpen={setOpenUpdate} />
                    ...
                    .map((category, idx) => (
                      ...
                      >
                        ...
                        <td
                          ...
                          className="px-3"
                        >
                          <span className="text-xs">{category.business}</span>
                        </td>
                        <td
                          onClick={() => {
                            setSelected(category.category_id);
